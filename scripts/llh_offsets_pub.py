...
def main():
    ...
    distances_pub = rospy.Publisher('distances_pub', Point32, queue_size=10) #x, y, z is d0, d1, d2
    # Initialise the node
    ...
    emlidSerial1=MSerialPort(port_name_from_serial_number(device_ids['emlid1']),57600)
    emlidSerial2=MSerialPort(port_name_from_serial_number(device_ids["emlid2"]),57600)
    emlidSerial3=MSerialPort(port_name_from_serial_number(device_ids['emlid3']),57600)
...
#            "A: " + str(MODEL_A) + ",n: " + str(MODEL_PLE) + ",window len: " + str(FILTER_WIDTH) + ",alpha: " + str(FILTER_ALPHA) +'\r\n' )
    ...
    gnd_truth_base_pos = np.array([3827306.74140728, -596220.52666460, 5050326.1968])
